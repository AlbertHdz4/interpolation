...
if __name__ == '__main__':
    ...
    (x_i, step) = np.linspace(0, 2 * np.pi, samples, retstep = True) # Espaciamiento regular de 0 - 2*Pi
    ...
    dom_interpol_poly = np.linspace(0, 2 * np.pi, samples) # Dominio regular de 0 - 2 * Pi
    # dom_interpol_poly = np.linspace(0, 1, samples, dtype = float) # Espaciamiento regular de 0 - 1
    # dom_interpol_poly = space_gen(0, 2 * np.pi, samples) # Dominio con espaciamiento aleatorio de 0 - 2 * Pi
    ...
    dom_lagrange  = np.linspace(0, 2 * np.pi, samples) # Dominio regular de 0 - 2*Pi
    # dom_lagrange  = np.linspace(0, 1, samples, dtype = float) # Espaciamiento regular de 0 - 1
    # dom_lagrange  = space_gen(0, 2 * np.pi, samples) # Dominio con espaciamiento aleatorio de 0 - 2*Pi
    ...
    """ Spline lineal ------------------------------------------------ """
    dom_linear_spline       = np.linspace(0, 2 * np.pi, samples) # Dominio regular de 0 - 2*Pi
    # dom_linear_spline     = np.linspace(0, 1, samples, dtype = float) # Espaciamiento regular de 0 - 1
    # dom_linear_spline     = space_gen(0, 2 * np.pi, samples) # Dominio con espaciamiento aleatorio de 0 - 2*Pi
    ...
    """ Spline cubico ------------------------------------------------ """
    dom_cubic_spline  = np.linspace(0, 2 * np.pi, samples) # Dominio regular de 0 - 2*Pi
    # dom_cubic_spline  = np.linspace(0, 1, samples, dtype = float) # Espaciamiento regular de 0 - 1
    # dom_cubic_spline  = space_gen(0, 2 * np.pi, samples) # Dominio con espaciamiento aleatorio de 0 - 2*Pi
